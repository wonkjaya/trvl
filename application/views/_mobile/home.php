...
<div class="about" id="about">
	  <div class="about-head text-center">
		  <h3>ABOUT US</h3>
		  <span></span><img src="assets/images/_mobile/about-img.png" alt=""><span></span>
	  </div>
	   <div class="container">		  
...
<div class="portfolio" id="toptours">
     <div class="top-tours-head text-center">
			  <h3>TOP TOURS</h3>
			  <span></span><img src="assets/images/_mobile/star.png" alt=""><span></span>
			  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
		  <div class="top-tours-grids">
		  <ul>
			 <li>ALL</li>
			 ...
			 <li>Long Date Tour</li>
			  ...
			  <img src="assets/images/_mobile/t1.jpg" class="img-responsive" alt=""/></a>
		      <img src="assets/images/_mobile/t3.jpg" class="img-responsive" alt=""/></a>
		  </div>
	 </div>  
</div>	  
<!--/top-tours-->
<div id="guides" class="tour-guides">
	  <div class="tour-guides-head text-center">
		  <h3>TOUR GUIDES</h3>
		  <span></span><img src="assets/images/_mobile/guide.png" alt=""><span></span>
		  <p>Lorem ipsum dolor sit amet, consectetur adipiscing.</p>
	  </div>				 
	 <div class="col-md-3 image-grid">
			<img src="assets/images/_mobile/g1.jpg" alt=""/>
...
<div class="client-say">
	 <div class="client-say-layer">
	     <div class="client-say-head text-center">
			  <h3>CLIENT SAY</h3>
			  <span></span><img src="assets/images/_mobile/face.png" alt=""><span></span>
...
<div id="contact" class="contact">
	  <div class="contact-head text-center">
		  <h3>CONTACT US</h3>
		  <span></span><img src="assets/images/_mobile/mail.png" alt=""><span></span>
	 ...
	 <div class="container">
		 <div class="fotter-grids">
			 <div class="col-md-4 fotter-left">
				 <img src="assets/images/_mobile/fotter-logo.png" alt="">
			 ...
			 <div class="col-md-4 fotter-middle">
				 ...
				 <div class="footer-list">
						<ul>
						<li><a href="#"><span></span>Sed ut perspiciatis iste natus.</a></li> 
						...
						<li><a href="#"><span></span>Nemo enim ipsum voluptatem quia.</a></li>
						</ul>
				 </div>
			 </div>

	     ...
	     <div class="about section" id="section-2">
			  <div class="about-head text-center"><br>
			  	...
			  	<ul id="filters" class="clearfix wow bounceIn" data-wow-delay="0.4s">
					...
					<li><span class="filter" data-filter="app">Family Cars</span></li>
					<li><span class="filter" data-filter="card">Mount Cars</span></li>
					<li><span class="filter" data-filter="icon">Street Cars</span></li>
					<li><span class="filter" data-filter="fun">Other Cars</span></li>
			    </ul>
